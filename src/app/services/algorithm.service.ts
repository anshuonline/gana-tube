...
export class AlgorithmService {
  ...
  public getAlgorithmicShortsQueries(languages: string[] = ['Hindi']): string[] {
    ...
    languages.forEach(lang => {
      // 1. Regional Viral & Shorts Hits (High engagement, regional trend)
      ...
      // 2. Personalized Artist queries (strictly bound with target language)
      if (topArtists.length > 0) {
    ...
    // Shuffle queries to guarantee dynamic variety across fetches
