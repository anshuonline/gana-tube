...
export class AdminManageSongsComponent {
  ...
  async publish() {
    ...
    try {
      ...
      const submitUrl = typeof window !== 'undefined' && window.location.origin.includes('localhost') ? 'http://localhost/manageads/save-songs.php' : 'https://manageads.ganatube.in/save-songs.php';
